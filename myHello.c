//*****************************************************************************
// Arseniy Gorbanev
// myHello.c - Simple hello world example with modified text, changed LED 
// behaviour and added button response functionality.
//
...
main(void)
{
    ...
    GrStringDrawCentered(&sContext, "yee boi", -1,
    ...
    GrStringDrawCentered(&sContext, "Hello Arseniy!", -1,
    ...
    //Constant for the waiting loop
    #define magicNumber  5000000
    ...
    while(1)
    {
        ...
        if(GPIOPinRead(GPIO_PORTM_BASE, GPIO_PIN_0)==1) {
          GPIOPinWrite(GPIO_PORTG_BASE, GPIO_PIN_2, GPIO_PIN_2);
        }
        ...
        // Delay for a bit.
        //
        for(ui32Loop = 0; ui32Loop < magicNumber; ui32Loop++)
        {
        }
